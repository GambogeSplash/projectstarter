import svgPaths from "./svg-3dak4fl22z";
...
import { imgBananaMint } from "./svg-zshd0";

function BackgroundImage1({ children }: React.PropsWithChildren<{}>) {
  return (
    <div style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 100%), linear-gradient(90deg, rgb(36, 38, 44) 0%, rgb(36, 38, 44) 100%)" }} className="basis-0 grow h-[68.757px] min-h-px min-w-px relative rounded-[11.459px] shrink-0">
      {children}
    </div>
  );
}
...
function BackgroundImage({ text, text1, additionalClassNames = "" }: BackgroundImageProps) {
  return (
    <div className={clsx("content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-center leading-[1.4] not-italic relative shrink-0 text-nowrap w-full", additionalClassNames)}>
      <p className="relative shrink-0 text-[#6c6c7d] text-[13.293px] tracking-[0.2659px]">{text}</p>
      <p className="relative shrink-0 text-[13.751px] text-white tracking-[0.1375px]">{text1}</p>
    </div>
  );
}
...
export default function IPhone() {
  return (
    <div className="bg-[#131316] relative size-full" data-name="iPhone 13 & 14 - 35">
      ...
      <div className="absolute bg-[#131316] border-[#191919] border-[0px_0px_1px] border-solid bottom-[88.73%] left-[calc(50%+0.5px)] top-[5.63%] translate-x-[-50%] w-[389px]" data-name="Header">
      ...
      <div className="absolute content-stretch flex flex-col gap-[6px] items-start left-1/2 top-[127px] translate-x-[-50%] w-[358px]">
          ...
          <div className="absolute content-stretch flex gap-[6px] items-center left-0 top-1/2 translate-y-[-50%]">
            <div className="relative shrink-0 size-[16px]" data-name="Frame">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                <g id="Frame">
                  <path d={svgPaths.p31cc9880} fill="var(--fill-0, white)" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="0.3" />
                </g>
              </svg>
            </div>
            <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-nowrap text-white">Product Details</p>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
          <div className="h-[323px] relative rounded-[10px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(rgb(239, 239, 239) 26.923%, rgb(27, 27, 31) 92.308%), linear-gradient(90deg, rgb(27, 27, 31) 0%, rgb(27, 27, 31) 100%)" }}>
            <div className="overflow-clip relative rounded-[inherit] size-full">
              ...
              <div className="absolute content-stretch flex flex-col gap-[2px] items-start justify-center left-[13px] not-italic text-nowrap top-[272.69px] w-[139.588px]">
                <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[14.299px] text-white tracking-[0.143px]">Blue Ankara Dress</p>
                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[#5e5e66] text-[12.483px] tracking-[0.1248px]">Current stock: 2 units</p>
              </div>
            </div>
          ...
          <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full">
            <div className="h-[40px] relative rounded-[7.887px] shrink-0 w-[176px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 100%), linear-gradient(90deg, rgb(45, 45, 52) 0%, rgb(45, 45, 52) 100%)" }}>
              <div className="overflow-clip relative rounded-[inherit] size-full">
                <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%-29.5px)] not-italic text-[13px] text-nowrap text-white top-[calc(50%-8px)] tracking-[0.13px]">Overview</p>
              </div>
            ...
            <div className="h-[40px] relative rounded-[7.887px] shrink-0 w-[176px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0.4) 100%), linear-gradient(90deg, rgb(45, 45, 52) 0%, rgb(45, 45, 52) 100%)" }}>
              <div className="overflow-clip relative rounded-[inherit] size-full">
                <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-[calc(50%-22px)] not-italic text-[#6c6c7d] text-[13px] text-nowrap top-[calc(50%-8px)] tracking-[0.26px]">Orders</p>
              </div>
              <div aria-hidden="true" className="absolute border-[#202026] border-[0.986px] border-solid inset-0 pointer-events-none rounded-[7.887px]" />
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[13.751px] items-start relative shrink-0 w-[358px]">
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-[9.168px] h-[258.985px] items-start relative rounded-[11.459px] shrink-0 w-full">
              <div className="h-[181.06px] relative rounded-[11.459px] shrink-0 w-[358px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.3) 100%), linear-gradient(90deg, rgb(36, 38, 44) 0%, rgb(36, 38, 44) 100%)" }}>
                <div aria-hidden="true" className="absolute border-[#1d1e23] border-[1.195px] border-solid inset-0 pointer-events-none rounded-[11.459px]" />
                <div className="absolute content-stretch flex flex-col gap-[10.314px] items-start left-1/2 top-[16px] translate-x-[-50%] w-[330px]">
                  <BackgroundImage text="Category" text1="Clothing" additionalClassNames="gap-[213px]" />
                  <BackgroundImage text="SKU" text1="PRD-001" additionalClassNames="gap-[243px]" />
                  <BackgroundImage text="Added" text1="Jan 10, 2024" additionalClassNames="gap-[204px]" />
                  <BackgroundImage text="Last Updated" text1="2 days ago" additionalClassNames="gap-[170px]" />
                  <div className="content-stretch flex gap-[158px] items-center relative shrink-0 w-full">
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#6c6c7d] text-[13.293px] text-nowrap tracking-[0.2659px]">Connected Apps</p>
                    <div className="content-stretch flex gap-[4.584px] items-center relative shrink-0 w-[71.888px]">
                      <div className="bg-[#25d366] overflow-clip relative rounded-[6.876px] shrink-0 size-[17.714px]">
                        <div className="absolute h-[10.22px] left-[calc(50%-0.03px)] top-[calc(50%-0.03px)] translate-x-[-50%] translate-y-[-50%] w-[10.164px]" data-name="Digital_Glyph_Green 1">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
                            <g clipPath="url(#clip0_5_4116)" id="Digital_Glyph_Green 1">
                              <path clipRule="evenodd" d={svgPaths.p8035a00} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
                            </g>
                            <defs>
                              <clipPath id="clip0_5_4116">
                                <rect fill="white" height="10.2203" width="10.1638" />
                              </clipPath>
                            </defs>
                          </svg>
                        </div>
                      </div>
                      <div className="relative rounded-[6.876px] shrink-0 size-[17.972px]" data-name="image 39">
                        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[6.876px] size-full" src={imgImage39} />
                      </div>
                      <div className="bg-[#e2eee7] overflow-clip relative rounded-[6.876px] shrink-0 size-[17.972px]">
                        <div className="absolute h-[12.648px] left-[calc(50%-0.05px)] top-[calc(50%-0.87px)] translate-x-[-50%] translate-y-[-50%] w-[11.09px]" data-name="image 592">
              ...
              <div className="content-stretch flex gap-[9.168px] items-center relative shrink-0 w-full">
                <BackgroundImage1>
                  <div aria-hidden="true" className="absolute border-[#1d1e23] border-[1.195px] border-solid inset-0 pointer-events-none rounded-[11.459px]" />
                  <div className="absolute content-stretch flex flex-col items-start left-[14px] top-[15.73px]">
                    <div className="content-stretch flex gap-[4.584px] items-center relative shrink-0">
                      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[13.751px] text-nowrap text-white tracking-[0.275px]">2</p>
                      <div className="h-[13.751px] overflow-clip relative rounded-[3.466px] shrink-0 w-[16.043px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(234, 37, 37) 0%, rgb(234, 37, 37) 100%), linear-gradient(90deg, rgb(45, 45, 52) 0%, rgb(45, 45, 52) 100%)" }}>
                        <div className="absolute left-1/2 size-[10.361px] top-[calc(50%-0.55px)] translate-x-[-50%] translate-y-[-50%]" data-name="Frame">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
                            <g id="Frame">
                              <path d={svgPaths.p292d2e00} fill="var(--fill-0, white)" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="0.413775" />
                            </g>
                          </svg>
                        </div>
                      </div>
                    </div>
                    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#6c6c7d] text-[12.605px] text-nowrap tracking-[0.2521px]">Units in Stock</p>
                  </div>
                </BackgroundImage1>
                <BackgroundImage1>
                  <div aria-hidden="true" className="absolute border-[#1d1e23] border-[1.195px] border-solid inset-0 pointer-events-none rounded-[11.459px]" />
                  <div className="absolute content-stretch flex flex-col items-start leading-[1.4] left-[14px] not-italic text-nowrap top-[15.73px]">
                    <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[13.751px] text-white tracking-[0.275px]">45</p>
                    <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#6c6c7d] text-[12.605px] tracking-[0.2521px]">Total Sold</p>
                  </div>
                </BackgroundImage1>
                <BackgroundImage1>
                  <div aria-hidden="true" className="absolute border-[#1d1e23] border-[1.195px] border-solid inset-0 pointer-events-none rounded-[11.459px]" />
                  <div className="absolute content-stretch flex flex-col items-start leading-[1.4] left-[14px] not-italic text-nowrap top-[15.73px]">
                    <div className="content-stretch flex gap-[2.292px] items-center relative shrink-0">
                      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[13.751px] text-white tracking-[0.275px]">₦675,000</p>
                      <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#2df18f] text-[9.168px] tracking-[0.1834px]">+12%</p>
                    </div>
                    <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#6c6c7d] text-[12.605px] tracking-[0.2521px]">Total Revenue</p>
                  </div>
                </BackgroundImage1>
              </div>
            </div>
          ...
          <div className="content-stretch flex flex-col gap-[11.459px] h-[99px] items-start relative shrink-0 w-full">
            <div className="bg-[#6060f8] h-[44px] overflow-clip relative rounded-[9.168px] shrink-0 w-full">
              <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[calc(50%-46.83px)] not-italic text-[14.21px] text-nowrap text-white top-[calc(50%-8.38px)]">Update Stock</p>
            </div>
      ...
      <div className="absolute bottom-[21px] content-stretch flex gap-[10px] items-center left-[calc(50%+6px)] translate-x-[-50%]" data-name="Tabs Mode Compact">
