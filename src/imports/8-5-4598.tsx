import svgPaths from "./svg-9s4iyrz5wy";
      ...
      <div className="absolute h-[60px] left-[248px] overflow-clip top-0 w-[1192px]">
        <div className="absolute content-stretch flex gap-[8px] items-start left-[1040px] top-[16.83px]">
          ...
          <div className="bg-[#1b1b1f] relative rounded-[7.746px] shrink-0 size-[28px]">
            <div className="overflow-clip relative rounded-[inherit] size-full">
              <div className="absolute flex items-center justify-center left-[calc(50%+0.16px)] size-[13.662px] top-[calc(50%+0.17px)] translate-x-[-50%] translate-y-[-50%]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
