import svgPaths from "./svg-noyutg7jjj";
...
function BackgroundImage2({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage2Props>) {
  return (
    <div style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%), linear-gradient(90deg, rgb(33, 33, 39) 0%, rgb(33, 33, 39) 100%)" }} className={clsx("h-[64px] relative shrink-0 w-full", additionalClassNames)}>
      {children}
    </div>
  );
}
...
export default function IPhone() {
  return (
    <div className="bg-[#131316] relative size-full" data-name="iPhone 13 & 14 - 28">
      <div className="absolute content-stretch flex flex-col gap-[18px] items-center left-1/2 overflow-clip top-[calc(50%-46.33px)] translate-x-[-50%] translate-y-[-50%] w-[350px]">
        ...
        <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full">
          <div className="content-stretch flex flex-col gap-[8px] h-[209px] items-start relative shrink-0 w-full">
            <BackgroundImage2 additionalClassNames="rounded-[12px]">
              <div aria-hidden="true" className="absolute border border-[#292b31] border-solid inset-0 pointer-events-none rounded-[12px]" />
              <div className="absolute content-stretch flex gap-[9.003px] h-[45.016px] items-center left-[11px] top-[calc(50%-0.65px)] translate-y-[-50%] w-[252.088px]">
                <div className="relative rounded-[11.254px] shrink-0 size-[38.263px]">
                  <div className="overflow-clip relative rounded-[inherit] size-full">
                    <div className="absolute bg-[#25d366] left-1/2 overflow-clip rounded-[6.145px] size-[22.508px] top-1/2 translate-x-[-50%] translate-y-[-50%]">
                      <div className="absolute h-[12.986px] left-[calc(50%-0.04px)] top-[calc(50%-0.04px)] translate-x-[-50%] translate-y-[-50%] w-[12.914px]" data-name="Digital_Glyph_Green 1">
                        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 13">
                          <g clipPath="url(#clip0_5_1855)" id="Digital_Glyph_Green 1">
                            <path clipRule="evenodd" d={svgPaths.p27bee900} fill="var(--fill-0, white)" fillRule="evenodd" id="Vector" />
                          </g>
                          <defs>
                            <clipPath id="clip0_5_1855">
                              <rect fill="white" height="12.9861" width="12.9143" />
                            </clipPath>
                          </defs>
                        </svg>
                      </div>
                  ...
                  <div aria-hidden="true" className="absolute border-[#2d2d34] border-[1.125px] border-solid inset-0 pointer-events-none rounded-[11.254px]" />
                </div>
                <div className="content-stretch flex flex-col gap-[1.125px] items-start leading-[1.4] not-italic relative shrink-0 text-nowrap">
                  <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[13.73px] text-white tracking-[0.2746px]">Whatsapp Business</p>
                  <p className="font-['Inter:Regular',sans-serif] font-normal relative shrink-0 text-[#6c6c7d] text-[12.379px] tracking-[0.2476px]">Connect with customers via...</p>
                </div>
              </div>
              <div className="absolute left-[281px] rounded-[6px] top-[calc(50%-0.65px)] translate-y-[-50%]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(44, 44, 53) 0%, rgb(44, 44, 53) 100%)" }}>
          ...
          <div className="bg-[#24242a] h-[44px] opacity-80 overflow-clip relative rounded-[8px] shrink-0 w-full">
            <div className="absolute content-stretch flex gap-[5.38px] items-center left-[calc(50%+2.51px)] opacity-60 top-1/2 translate-x-[-50%] translate-y-[-50%]">
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[13.342px] text-nowrap text-white">Confirm</p>
              <div className="relative shrink-0 size-[13.996px]" data-name="Frame">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                  <g id="Frame">
                    <path d={svgPaths.p136ff900} fill="var(--fill-0, white)" id="Vector" stroke="var(--stroke-0, white)" strokeWidth="0.199946" />
                  </g>
                </svg>
              </div>
            </div>
