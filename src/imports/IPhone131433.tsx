...
function Frame1({ children, additionalClassNames = "" }: React.PropsWithChildren<Frame1Props>) {
  return (
    <div className={clsx("absolute left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%]", additionalClassNames)}>
...
function Frame({ children, additionalClassNames = "" }: React.PropsWithChildren<FrameProps>) {
  return (
...
export default function IPhone() {
  return (
    <div className="bg-[#131316] relative size-full" data-name="iPhone 13 & 14 - 33">
      ...
      <div className="absolute h-[577px] left-1/2 top-[156px] translate-x-[-50%] w-[358px]">
        <div className="absolute bg-[#6060f8] h-[26.269px] left-0 overflow-clip rounded-[6.866px] top-[87px] w-[26.716px]">
          <Frame additionalClassNames="size-[15.715px] top-[calc(50%+0.22px)]">
            <path d={svgPaths.pc797300} fill="var(--fill-0, white)" id="Vector" />
          </Frame>
        </div>
        <div className="absolute h-[285px] left-[39px] top-[96px] w-[319px]">
          <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[1.6] left-0 not-italic text-[#b6b6c4] text-[14px] top-[-8px] tracking-[0.14px] w-[319px]">
            <p className="mb-0">{`Determining a "very good" weight for a 5'8", 25-year-old guy can depend on various factors, including body composition, muscle mass, and overall health. However, a commonly used measure is the Body Mass Index (BMI), which provides a general guideline.`}</p>
            <p className="mb-0">&nbsp;</p>
            <p className="mb-0">{`For a 5'8" individual, a healthy weight range according to BMI is typically between 129 lbs (63 kg) and 174 lbs (79 kg). This corresponds to a BMI of 18.5 to 24.9, which is considered normal.`}</p>
            <p>&nbsp;</p>
          </div>
        </div>
        <div className="absolute bg-[#26262c] border border-[#28282f] border-solid h-[65px] left-[82px] overflow-clip rounded-[16px] top-0 w-[276px]">
          <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[1.5] left-[calc(50%-121px)] not-italic text-[14px] text-white top-[8.04px] tracking-[0.14px] w-[260.895px]">What’s a very good weight for a 5’8, 25 year old guy</p>
        </div>
        <div className="absolute bg-[#1f1f24] border border-[#2d2d34] border-solid left-1/2 overflow-clip rounded-[90px] size-[30px] top-[389px] translate-x-[-50%]">
          <Frame1 additionalClassNames="size-[14px]">
            <path d={svgPaths.p2ff05080} fill="var(--fill-0, #5D5D66)" id="Vector" stroke="var(--stroke-0, #5D5D66)" strokeWidth="0.4" />
          </Frame1>
        </div>
        <div className="absolute content-stretch flex flex-col gap-[10px] items-center left-1/2 top-[430px] translate-x-[-50%] w-[358px]">
          <div className="bg-[#1b1b1f] h-[118px] relative rounded-[14px] shrink-0 w-full">
            <div className="overflow-clip relative rounded-[inherit] size-full">
              <div className="absolute content-stretch flex items-center left-[16px] top-[70px]">
                <div className="content-stretch flex gap-[11px] items-center relative shrink-0">
                  ...
                  <div className="bg-[#1f1f24] relative rounded-[10px] shrink-0 size-[34px]">
                    <div className="overflow-clip relative rounded-[inherit] size-full">
                      <Frame1 additionalClassNames="size-[13.996px]">
              ...
              <div className="absolute bg-white left-[313px] overflow-clip rounded-[10px] size-[34px] top-[70px]">
                <Frame additionalClassNames="size-[16px] top-1/2">
                  <path d={svgPaths.p50a8e00} fill="var(--fill-0, black)" id="Vector" stroke="var(--stroke-0, black)" strokeWidth="0.6" />
                </Frame>
              </div>
            ...
            <div aria-hidden="true" className="absolute border border-[#25252b] border-solid inset-0 pointer-events-none rounded-[14px]" />
          </div>
      ...
      <div className="absolute bottom-[34px] content-stretch flex gap-[10px] items-center left-[calc(50%+6px)] translate-x-[-50%]" data-name="Tabs Mode Compact">
        <ButtonText text="􀯶" />
