import svgPaths from "./svg-f6oxiuj9uw";
import imgImage30 from "figma:asset/a283c4770f4329f7b6f5fd17fd6443562040eeac.png";

function Frame1({ children }: React.PropsWithChildren<{}>) {
  return (
...
export default function Component() {
  return (
    <div className="bg-[#131316] relative size-full" data-name="6">
      <div className="absolute bg-[#131316] border-[#2f2f31] border-[0px_0.5px_0px_0px] border-solid h-[830px] left-0 overflow-clip top-0 w-[248px]">
        ...
        <div className="absolute bg-[#1f1f24] border-[#6060f8] border-[0px_0px_0px_2px] border-solid h-[36px] left-0 top-[78px] w-[248px]" />
        ...
        <div className="absolute content-stretch flex flex-col gap-[25px] items-start left-[22px] top-[89px] w-[214px]">
          <div className="content-stretch flex flex-col gap-[18px] items-start relative shrink-0 w-full">
            <div className="content-stretch flex gap-[8.082px] items-center relative shrink-0 w-full">
              <div className="relative shrink-0 size-[15.153px]" data-name="Frame">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                  <g id="Frame">
                    <path d={svgPaths.p2145ec80} fill="var(--fill-0, white)" id="Vector" />
                  </g>
                </svg>
              </div>
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[12.527px] text-nowrap text-white tracking-[0.1253px]">New Chat</p>
            </div>
            <div className="content-stretch flex gap-[8.082px] items-center relative shrink-0 w-full">
              <div className="relative shrink-0 size-[15.153px]" data-name="Frame">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
      ...
      <div className="absolute bg-[#131316] h-[830px] left-[248px] top-0 w-[1192px]" />
      <div className="absolute content-stretch flex flex-col gap-[24px] items-center left-[486px] top-[249px] w-[716px]">
        <div className="overflow-clip relative shrink-0 size-[64px]">
          <div className="absolute left-1/2 size-[64px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="Frame">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 64 64">
              <g id="Frame">
                <path d={svgPaths.p1eee60b0} fill="var(--fill-0, #33FFCC)" id="Vector" />
              </g>
            </svg>
          </div>
        </div>
            ...
            <div className="absolute content-stretch flex gap-[16px] items-center left-[16px] top-[70px]">
              ...
              <div className="content-stretch flex gap-[14px] items-center relative shrink-0">
                <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[78px]">
                  <Frame>
                    <path d={svgPaths.p2739a900} fill="var(--fill-0, #5E5E66)" id="Vector" stroke="var(--stroke-0, #5E5E66)" strokeWidth="0.4" />
                  </Frame>
                ...
                <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-[55px]">
                  <div className="relative shrink-0 size-[14px]" data-name="Frame">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 14">
                      <g id="Frame">
                        <path d={svgPaths.p9b44c00} fill="var(--fill-0, #5E5E66)" id="Vector" stroke="var(--stroke-0, #5E5E66)" strokeWidth="0.4" />
                      </g>
                    </svg>
                  </div>
      ...
      <div className="absolute left-[1404.02px] size-[18.979px] top-[24px]" data-name="Frame">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 19 19">
          <g id="Frame">
            <path d={svgPaths.p122f7000} fill="var(--fill-0, #5E5E66)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
