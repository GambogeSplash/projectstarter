import svgPaths from "./svg-28wswsynez";
...
export default function Component() {
  return (
    <div className="bg-[#131316] relative size-full" data-name="20">
        ...
        <div className="absolute content-stretch flex flex-col gap-[18px] items-center left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[404px]">
          ...
          <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-[8px] h-[178px] items-start relative shrink-0 w-full">
              <div className="h-[54px] relative rounded-[10px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(90deg, rgba(96, 96, 248, 0.04) 0%, rgba(96, 96, 248, 0.04) 100%), linear-gradient(90deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%), linear-gradient(90deg, rgb(33, 33, 39) 0%, rgb(33, 33, 39) 100%)" }}>
                ...
                <div className="absolute content-stretch flex items-center justify-center left-[322.81px] overflow-clip px-[6px] py-[4px] rounded-[6px] top-1/2 translate-y-[-50%]" style={{ backgroundImage: "linear-gradient(90deg, rgb(96, 96, 248) 0%, rgb(96, 96, 248) 100%), linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(90deg, rgb(44, 44, 53) 0%, rgb(44, 44, 53) 100%)" }}>
            ...
            <div className="bg-[#24242a] h-px shrink-0 w-[404px]" />
            <div className="bg-[#24242a] h-[36px] opacity-80 overflow-clip relative rounded-[8px] shrink-0 w-full">
              <div className="absolute bg-[rgba(96,96,248,0)] h-[36px] left-0 rounded-[8px] top-1/2 translate-y-[-50%] w-px" />
